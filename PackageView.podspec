#
#  Be sure to run `pod spec lint PackageView.podspec' to ensure this is a
...
#  s.description  = <<-DESC
 ...
 # s.homepage     = "http://EXAMPLE/PackageView"
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "tryFighting" => "2893381320@qq.com" }
  # Or just: s.author    = "tryFighting"
  # s.authors            = { "tryFighting" => "2893381320@qq.com" }
  # s.social_media_url   = "http://twitter.com/tryFighting"
 ...
 # s.source       = { :git => "http://EXAMPLE/PackageView.git", :tag => "#{s.version}" }
